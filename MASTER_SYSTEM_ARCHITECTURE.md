# MASTER SYSTEM ARCHITECTURE & CODEBASE STATE
### Zero-Trust Agentic Micro-Refinery v3.1
*Generated by reverse-engineering of `C:\Users\Laksh\Documents\hail_marry`*
...
**Notable missing dependency:** `langgraph` is used (`from langgraph.prebuilt import create_react_agent`) but not listed in `requirements.txt`. Must be installed separately: `pip install langgraph`.
